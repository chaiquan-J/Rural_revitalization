    ...
    <div class="conent">
      ...
      <div class="con_body">
        ...
        <div class="max_box" v-for="item in conent_text" :key="item.id">
          <!-- 条件渲染，判断内容的显示方向，通过判断参数direction是0还是1，-->
          <!-- 1则是true，0则是false,如果结果是false就会让内容的显示方式为另一个方向 -->
...
import developimg5 from "@/assets/img/developimg10.png";
    ...
    return {
      conent_text: [
        ...
        },
        {
          ...
          direction: 0,
          src: developimg5,
          title_text: "农业农村经济发展稳中向好",
          text: "   今年以来，我市认真落实中央、自治区农村工作会议精神，围绕加快推进乡村振兴工作部署，严格落实好稳产保供各项政策措施，切实做好农业农村工作。上半年，全市农业农村经济运行总体平稳、稳中向好。\n   狠抓现有财政支农政策落实落地。我市加快中央财政转移支付资金执行进度，督促各县（市、区）不误农时，及时拨付支持粮油生产等各类政策资金，不断优化实际种粮农民一次性补贴、耕地地力补贴等发放方式，提高精准性、便捷性，确保资金及时足额发放到相关主体。今年以来，全市共发放第一批实际种粮农民一次性补贴1800万元、第二批实际种粮农民一次性补贴1469万元，预计7月份全部完成资金发放。我市继续实施稻谷补贴政策，下达2022年稻谷生产补贴2342万元，预计8月份完成晚稻种植后可确定种植面积，年底前完成补贴资金发放。落实2022年耕地地力保护补贴2.43亿元，6月底前全部发放到农民手中。",
        },
        {
          id: 3,
          direction: 1,
